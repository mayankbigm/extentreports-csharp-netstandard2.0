...
namespace AventStack.ExtentReports.Core
{
    public class ReportStatusStats
    {
        ...
        public double ParentPercentagePass
        {
            get
            {
                var i = ParentCount > 0 ? ParentCountPass / (double)ParentCount : 0;
                return i * 100;
            }
        }
        public double ParentPercentageFail
        {
            get
            {
                var i = ParentCount > 0 ? (ParentCountFail + ParentCountFatal) / (double)ParentCount : 0;
                return i * 100;
            }
        }
        public double ParentPercentageSkip
        {
            get
            {
                var i = ParentCount > 0 ? ParentCountSkip / (double)ParentCount : 0;
                return i * 100;
            }
        }
        public double ParentPercentageWarning
        {
            get
            {
                var i = ParentCount > 0 ? ParentCountWarning / (double)ParentCount : 0;
                return i * 100;
            }
        }
        public double ParentPercentageOthers
        {
            get
            {
                var i = ParentCount > 0 ? (ParentCountWarning + ParentCountError) / (double)ParentCount : 0;
                return i * 100;
            }
        }
        ...
        public double ChildPercentagePass
        {
            get
            {
                var i = ChildCount > 0 ? ChildCountPass / (double)ChildCount : 0;
                return i * 100;
            }
        }
        public double ChildPercentageFail
        {
            get
            {
                var i = ChildCount > 0 ? (ChildCountFail + ChildCountFatal) / (double)ChildCount : 0;
                return i * 100;
            }
        }
        public double ChildPercentageSkip
        {
            get
            {
                var i = ChildCount > 0 ? ChildCountSkip / (double)ChildCount : 0;
                return i * 100;
            }
        }
        public double ChildPercentageWarning
        {
            get
            {
                var i = ChildCount > 0 ? ChildCountWarning / (double)ChildCount : 0;
                return i * 100;
            }
        }
        public double ChildPercentageOthers
        {
            get
            {
                var i = ChildCount > 0 ? (ChildCountWarning + ChildCountError) / (double)ChildCount : 0;
                return i * 100;
            }
        }
        ...
        public double GrandChildPercentagePass
        {
            get
            {
                var i = GrandChildCount > 0 ? GrandChildCountPass / (double)GrandChildCount : 0;
                return i * 100;
            }
        }
        public double GrandChildPercentageFail
        {
            get
            {
                var i = GrandChildCount > 0 ? (GrandChildCountFail + GrandChildCountFatal) / (double)GrandChildCount : 0;
                return i * 100;
            }
        }
        public double GrandChildPercentageSkip
        {
            get
            {
                var i = GrandChildCount > 0 ? GrandChildCountSkip / (double)GrandChildCount : 0;
                return i * 100;
            }
        }
        public double GrandChildPercentageWarning
        {
            get
            {
                var i = GrandChildCount > 0 ? GrandChildCountWarning / (double)GrandChildCount : 0;
                return i * 100;
            }
        }
        public double GrandChildPercentageOthers
        {
            get
            {
                var i = GrandChildCount > 0 ? (GrandChildCountWarning + GrandChildCountError) / (double)GrandChildCount : 0;
                return i * 100;
            }
        }
        ...
        private void RefreshStats()
        {
            lock (_synclock)
            {
                _testList.ForEach(AddTestForStatusStatsUpdate);
            }
        }
        ...
        private void UpdateGroupCountsBdd(Test test)
        {
            ...
            { 
                ...
                {
                    throw new InvalidAnalysisStrategyException(child.Name + " is not a valid BDD test. This happens when using AnalysisStrategy.BDD" +
                                                               " without BDD-style tests or if the test was not marked with the appropriate BDD type.");
                }
