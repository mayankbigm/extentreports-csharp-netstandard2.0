...
namespace AventStack.ExtentReports.Model
{
    ...
    public class ScreenCapture : Media
    {
        ...
        public string ScreenCapturePath => !string.IsNullOrEmpty(base.Path) ? base.Path : Base64StringDataType + Base64String;

        public bool IsBase64 => !string.IsNullOrEmpty(Base64String);
    }
}
